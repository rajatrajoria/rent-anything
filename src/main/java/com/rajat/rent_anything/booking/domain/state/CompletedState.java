...
public class CompletedState implements BookingState {
    ...
    public void confirm(Booking booking) {
        throw new InvalidStateActionException("Completed booking cannot be confirmed");
    }

    @Override
    public void cancel(Booking booking) {
        throw new InvalidStateActionException("Completed booking cannot be cancelled");
    }

    @Override
    public void expire(Booking booking) {
        throw new InvalidStateActionException("Completed booking cannot expire");
    }

    @Override
    public void complete(Booking booking) {
        throw new InvalidStateActionException("Booking is already completed");
    }
}