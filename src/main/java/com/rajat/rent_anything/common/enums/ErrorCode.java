...
public enum ErrorCode {
    ...
    IMAGE_STORAGE_FAILURE("ITM_009", "Image storage operation failed", HttpStatus.INTERNAL_SERVER_ERROR),
    INVALID_IMAGE_COUNT("ITM_010", "Invalid number of images", HttpStatus.BAD_REQUEST),
